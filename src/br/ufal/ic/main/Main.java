...
public class Main {
	...
	public static void main(String[] args) {
		...
		try (final BaseXClient session = new BaseXClient("localhost", 1984, "admin", "admin")) {
			...
			// Tow usando o modelo d consulta SQL sÃ³ pra poder fazer uma unica
			...
			if (choice == 1) {
				...
				//System.out.println("As matérias na base são:\n");
				//for (Materia m : materias) {
				//					System.out.println(m.nome);
				//			}
				...
				try {
					...
					/*
					 *
					 * Caio aki vocÃª monta a query com o formato do FireBase
					 * usando o SELEC FROM WHERE ORDERBY que o usuÃ¡rio deu e
					 * printa na tela.
					 *
					 */
				} catch (Exception e) {
